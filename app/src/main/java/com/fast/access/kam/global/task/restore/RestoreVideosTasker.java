 ...
 */
public class RestoreVideosTasker extends AsyncTask<Void, ProgressModel, ProgressModel> {

    private Context context;
    private OnTaskLoading onTaskLoading;
    private OnProgress onProgress;

    public RestoreVideosTasker(Context context, OnTaskLoading onTaskLoading, OnProgress onProgress) {
