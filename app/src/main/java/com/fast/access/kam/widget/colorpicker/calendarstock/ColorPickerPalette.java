package com.fast.access.kam.widget.colorpicker.calendarstock;
...
/**
 * A color picker custom view which creates an grid of color squares.  The number of squares per row (and the padding between the squares) is
...
public class ColorPickerPalette extends TableLayout {
    ...
    /**
     * Add a content description to the specified swatch view. Because the colors get added in a snaking form, every other row will need to compensate
     * for the fact that the colors are added in an opposite direction from their left->right/top->bottom order, which is how the system will arrange
