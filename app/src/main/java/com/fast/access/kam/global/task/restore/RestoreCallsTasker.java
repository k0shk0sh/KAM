 ...
 */
public class RestoreCallsTasker extends AsyncTask<Void, ProgressModel, ProgressModel> {

    private Context context;
    private OnTaskLoading onTaskLoading;
    private OnProgress onProgress;

    public RestoreCallsTasker(Context context, OnTaskLoading onTaskLoading, OnProgress onProgress) {
