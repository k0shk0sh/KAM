 ...
 */
public class RestoreImagesTasker extends AsyncTask<Void, ProgressModel, ProgressModel> {

    private Context context;
    private OnTaskLoading onTaskLoading;
    private OnProgress onProgress;

    public RestoreImagesTasker(Context context, OnTaskLoading onTaskLoading, OnProgress onProgress) {
