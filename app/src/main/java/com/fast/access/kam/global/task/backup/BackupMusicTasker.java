 ...
 */
public class BackupMusicTasker extends AsyncTask<Void, ProgressModel, ProgressModel> {

    private Context context;
    private OnTaskLoading onTaskLoading;
    private OnProgress onProgress;

    public BackupMusicTasker(Context context, OnTaskLoading onTaskLoading, OnProgress onProgress) {
